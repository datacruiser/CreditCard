...
#最终模型入选变量
fitcols <- c("default",
             "refuse_12month_product_woe",
             "refuse_product_woe",
             "refuse_3month_product_woe",
             "refuse_2month_product_woe",
             "refuse_1month_product_woe",
             "refuse_1month_apply_woe",
             "loan_7day_amount_woe",
             "loan_3month_amount_woe",
             "loan_3month_product_woe",
             "loan_3month_apply_woe",
             "normal_overdue_woe",
             "apply_normal_woe",
             "loan_12month_product_woe",
             "score_woe",
             "confirm_apply_woe",
             "confirm_12month_product_woe",
             "each_other_count_2m_rate_woe",
             "confirm_product_woe",
             "confirm_3month_product_woe",
             "dateDelta_first_apply_to_first_loan_woe",
             "confirm_2month_apply_woe",
             "call_time_15srate_woe",
             "inittime_woe",
             "call_3time_15s_woe",
             "confirm_2month_product_woe",
             "p2p_approve_3month_product_woe",
             "confirm_1month_apply_woe",
             "relation_model_num_woe",
             "deposit_base_woe",
             "confirm_1month_product_woe"
